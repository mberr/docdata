...
----------------------------------
1. Check that you have the latest version of :code:`docdata`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/cthoyt/docdata/issues
...
1. Get the code. Fork the repository from GitHub using the big green button in the top-right corner of
   https://github.com/cthoyt/docdata
2. Clone your directory with

.. code-block:: sh

    $ git clone https://github.com/<YourUsername>/docdata
...
If you spend a while working on your changes, further commits may be made to the main :code:`docdata`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/cthoyt/docdata
